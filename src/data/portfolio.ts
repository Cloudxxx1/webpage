...
export const profile = {
  ...
  philosophy:
    '我相信，优秀的视觉系统不仅要在数据中表现出色，更要在复杂环境、真实设备与连续运行中保持可靠。研究是起点，落地才让技术真正产生价值。',
  location: '福建 · 福州',
...
export const projects: Project[] = [
  {
    ...
    responsibilities: [
      '设计光照判别增强子网络;',
      '研究跨模态语义引导调制机制;',
      '有效实现复杂光照情况下的动态低照度增强以及保留双模态的有效信息，在EN、SF、SD、AG、VIF等指标中取得优异的表现;',
    ],
    approach: [
      '依据光照状态自适应修复可见光退化特征;',
      '在频域与空域中联合建模纹理和结构信息;',
  ...
  },
  {
    ...
    responsibilities: [
      ...
      '实现离线地图部署与GPS定位结合的轨迹绘制;',
      '在机载端基于大疆PSDK实现云台视频拉流，实时检测，并通过MSDK发送到手柄段显示;',
    ],
    approach: [
      '融合双模态互补信息提升复杂背景可辨识度;',
      '将检测结果接入多目标轨迹关联;',
...
export const capabilities = [
  {
    ...
    icon: 'scan',
    title: '智能光学图像处理',
    description: '双模态图像增强与融合、目标检测、目标跟踪。',
  },
  {
    id: 'tracking',
    number: '02',
