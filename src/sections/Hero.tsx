  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 perspective-1000">
        ...
        >
          <span className="text-gradient">{isEnglish ? 'Yitao Cao' : '曹义涛'}</span>
        </h1>
        ...
        <div className="mt-10 flex justify-center gap-6">
          {[
            { name: 'GitHub', icon: 'github', href: 'https://github.com/Cloudxxx1' },
            { name: 'WeChat', icon: 'wechat', href: '#' },
            { name: 'ORCID', icon: 'orcid', href: 'https://orcid.org/0009-0005-3304-1540' },
          ].map((social) => {
