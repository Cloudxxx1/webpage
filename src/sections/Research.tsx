...
const papers: Paper[] = [
  ...
  //   authors: 'Yitao Cao, Kaimin Yu, Huayang He, Feng Huang, Xianyu Wu, Yating Chen',
  ...
  //   github: 'https://github.com/Cloudxxx1/MuS-Polar3D.git',
  //   type: 'paper',
  // },
  // {
  ...
  //   authors: 'Kaimin Yu, Yitao Cao, Huayang He, Xianyu Wu',
  //   journal: 'International Conference on Machine Learning (CCF-A，投稿中）',
  //   year: '2025',
  //   abstract:
  ...
  //   authors: 'Kaimin Yu, Yitao Cao, Fei Dong, Xu Li, Xianyu Wu, FengHuang',
  ...
  // },
  {
    ...
    authors: 'Yitao Cao, Xianyu Wu, Jiacai Lin, FengHuang',
  ...
  zh: [
    {
      ...
      inventors: '朱兆聚,曹义涛,黄海涛,曹泰源,陈栋,苏晨烨',
      number: 'CN116923583A',
      date: '2023',
      abstract:
  ...
  en: [
    {
      ...
      inventors: 'Zhaoju Zhu, Yitao Cao, Haitao Huang, Taiyuan Cao, Dong Chen, Chenye Su',
      number: 'CN116923583A',
      date: '2023',
      abstract:
